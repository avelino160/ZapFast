...
const translations: Record<string, Record<string, string>> = {
  'pt-BR': {
    ...
    'unlimited_funnels': 'Fluxo ilimitado',
    ...
    'sales_funnels_limit': 'fluxo de venda',
  ...
  'en-US': {
    ...
    'unlimited_funnels': 'Unlimited flows',
    ...
    'sales_funnels_limit': 'sales flows',
  ...
  'es-ES': {
    ...
    'unlimited_funnels': 'Flujos ilimitados',
    ...
    'sales_funnels_limit': 'flujos de venta',
